...
function App() {
	...
	return (
		<main className="min-h-screen bg-black text-white relative overflow-x-hidden" style={{ fontFamily: '"BR Firma", sans-serif' }}>
			...
			<div className="text-3xl sm:text-4xl md:text-8xl flex items-center justify-center font-bold pt-6 sm:pt-8 text-center bg-gradient-to-r from-white to-gray-400/90 text-transparent bg-clip-text" style={{ fontFamily: '"BR Firma", sans-serif' }}>
				CLOAK ME
			</div>
