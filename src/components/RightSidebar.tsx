...
import gpay from "../../public/game.png";
        ...
        <div className="mb-6 bg-neutral-900 rounded-xl p-4">
          ...
          <div className="mt-4 bg-neutral-800 rounded-xl p-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/saransh-bhat-216ab2327/"
                target="_blank"
              ...
              {/* Email */}
              <a
                href="mailto:saranshbhat777@gmail.com"
                className="flex flex-col items-center group"
              >
              ...
              {/* X (Twitter) */}
              <a
                href="https://x.com/BhatSarans95021"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center group"
              >
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/saransh_bhat_3/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center group"
              >
